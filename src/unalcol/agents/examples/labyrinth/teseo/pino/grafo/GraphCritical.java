...
public class GraphCritical implements Graph
{
    ...
    private Map<Coord, Node> vertices = new HashMap<Coord, Node>();
    private Node ultimo;
    private ArrayList<Integer> dir = new ArrayList<Integer>();
    ...
    {
        ArrayList<Node> qq = new ArrayList<Node>();
        ArrayList<Node> pp = new ArrayList<Node>();
