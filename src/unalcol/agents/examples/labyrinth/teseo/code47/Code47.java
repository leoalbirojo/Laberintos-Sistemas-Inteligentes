...
import unalcol.agents.examples.labyrinth.teseo.code47.grafo.SimpleTeseoAgentProgram;
 ...
 * @author Andres
 */
public class Code47 extends SimpleTeseoAgentProgram {
    ...
    public Code47(SimpleLanguage _language) {
    ...
    public int accion(boolean PF, boolean PD, boolean PA, boolean PI, boolean MT
        ...
        if (AF || AD || AA || AI){
            //System.out.println("Ups, un Agente...me quedare quieto");
            try {
                Thread.sleep(3000);
                //System.out.println("jeje...continuare");
            } catch (InterruptedException ex) {
                System.err.println("mmm...no pude dormir...creo que mori");
            }
        }
    ...
    /**
     * Actualiza el parámetro de posición para conocer en que posición está el
     * agente despues de ejecutar las acciones.
     *
     * @param r
     */
    ...
    public int findOtherWay(boolean PF, boolean PD, boolean PA, boolean PI, boolean AF, boolean AD, boolean AA, boolean AI) {
        try {
            System.out.println("pensando una solucion...");
            Thread.sleep(1000);
        } catch (InterruptedException ex) {
            System.out.println("no puede pensar una solucion...");
            Logger.getLogger(Code47.class.getName()).log(Level.SEVERE, null, ex);
        }
        return 5;
    }
