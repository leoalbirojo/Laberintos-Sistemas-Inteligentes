...
public abstract class SimpleTeseoAgentProgram  implements AgentProgram{
  ...
  protected Stack<GraphNode> goBackSolution = new Stack<GraphNode>(); //Son los nodods que debe visitar para llegar a un nodo de desición anterior
  ...
  protected ArrayList<GraphNode> TwoWallsNodes = new ArrayList<GraphNode>();
